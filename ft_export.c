...
/*   Updated: 2024/05/17 15:31:27 by mmad             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_buffer_to_list(t_list **head, char **command)
{
	...
	{
		ft_lstadd_back(head, ft_lstnew((char *)"SHLVL=1"));
		ft_lstadd_back(head,
			ft_lstnew((char *)"PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/home/mmad/.local/bin/:/home/mmad/.local/bin/"));
		ft_lstadd_back(head, ft_lstnew((char *)"_=/usr/bin/env"));
	}
}
